...
class FlatRatePackingPage extends StatefulWidget {
  const FlatRatePackingPage({super.key});

  @override
  State<FlatRatePackingPage> createState() => _FlatRatePackingPageState();
}

class _FlatRatePackingPageState extends State<FlatRatePackingPage> {
