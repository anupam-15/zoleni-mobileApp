...
class OrderQuoteDetails extends StatefulWidget {
  const OrderQuoteDetails({super.key});

  @override
  State<OrderQuoteDetails> createState() => _OrderQuoteDetailsState();
}

class _OrderQuoteDetailsState extends State<OrderQuoteDetails> {
  @override
