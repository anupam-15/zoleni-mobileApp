...
class NextDayDeliveryPackageInformation extends StatefulWidget {
  const NextDayDeliveryPackageInformation({super.key});

  @override
  State<NextDayDeliveryPackageInformation> createState() => _NextDayDeliveryPackageInformationState();
}

class _NextDayDeliveryPackageInformationState extends State<NextDayDeliveryPackageInformation> { String? selectDropSelect;
String? selectUnit;
