...
import 'package:zoleni/view/delivery_client/Next%20Day/next_day_delivery_package_information.dart';
...
class NextDayDeliveryReceiver extends StatefulWidget {
  const NextDayDeliveryReceiver({super.key});

  @override
  State<NextDayDeliveryReceiver> createState() => _NextDayDeliveryReceiverState();
}

class _NextDayDeliveryReceiverState extends State<NextDayDeliveryReceiver> {
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Next Day Delivery Order-Receiver Details",
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                       Get.to(NextDayDeliveryPackageInformation());
                      },
                      child: Text(
                        "Next",
                        style: TextStyle(
