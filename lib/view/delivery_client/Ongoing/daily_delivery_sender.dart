...
class DailyDeliverySender extends StatefulWidget {
  const DailyDeliverySender({super.key});

  @override
  State<DailyDeliverySender> createState() => _DailyDeliverySenderState();
}

class _DailyDeliverySenderState extends State<DailyDeliverySender> {
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Daily Ongoing Delivery Order- Sender Details",
