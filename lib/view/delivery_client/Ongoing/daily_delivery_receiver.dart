...
class DailyDeliveryReceiver extends StatefulWidget {
  const DailyDeliveryReceiver({super.key});

  @override
  State<DailyDeliveryReceiver> createState() => _DailyDeliveryReceiverState();
}

class _DailyDeliveryReceiverState extends State<DailyDeliveryReceiver> {
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Get.to(DailyDeliveryPackageInformation());
                      },
                      child: Text(
                        "Next",
                        style: TextStyle(
