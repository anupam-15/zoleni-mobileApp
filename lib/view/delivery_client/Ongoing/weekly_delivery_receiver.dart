...
import 'package:zoleni/view/delivery_client/Ongoing/daily_delivery_package_information.dart';
import 'package:zoleni/view/delivery_client/Ongoing/weekly_delivery_package_information.dart';
...
class WeeklyDeliveryReceiver extends StatefulWidget {
  const WeeklyDeliveryReceiver({super.key});

  @override
  State<WeeklyDeliveryReceiver> createState() => _WeeklyDeliveryReceiverState();
}

class _WeeklyDeliveryReceiverState extends State<WeeklyDeliveryReceiver> {
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Daily Ongoing Delivery Order-Receiver Details",
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Get.to(WeeklyDeliveryPackageInformation());
                      },
                      child: Text(
                        "Next",
                        style: TextStyle(
