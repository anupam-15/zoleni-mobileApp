...
class WeeklyDeliveryPackageInformation extends StatefulWidget {
  const WeeklyDeliveryPackageInformation({super.key});

  @override
  State<WeeklyDeliveryPackageInformation> createState() => _WeeklyDeliveryPackageInformationState();
}

class _WeeklyDeliveryPackageInformationState extends State<WeeklyDeliveryPackageInformation> { String? selectDropSelect;
String? selectUnit;
