...
class DailyDeliveryPackageInformation extends StatefulWidget {
  const DailyDeliveryPackageInformation({super.key});

  @override
  State<DailyDeliveryPackageInformation> createState() => _DailyDeliveryPackageInformationState();
}

class _DailyDeliveryPackageInformationState extends State<DailyDeliveryPackageInformation> { String? selectDropSelect;
String? selectUnit;
