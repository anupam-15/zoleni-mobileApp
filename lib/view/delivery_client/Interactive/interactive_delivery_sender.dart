...
class InteractiveDeliverySender extends StatefulWidget {
  const InteractiveDeliverySender({super.key});

  @override
  State<InteractiveDeliverySender> createState() => _InteractiveDeliverySenderState();
}

class _InteractiveDeliverySenderState extends State<InteractiveDeliverySender> {
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Get.to(InteractiveDeliveryReceiver());
                      },
                      child: Text(
                        "Next",
                        style: TextStyle(
