...
class NowDeliveryOrderReceiver extends StatefulWidget {
  const NowDeliveryOrderReceiver({super.key});

  @override
  State<NowDeliveryOrderReceiver> createState() => _NowDeliveryOrderReceiverState();
}

class _NowDeliveryOrderReceiverState extends State<NowDeliveryOrderReceiver> {
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                       Get.to(NowDeliveryPackageInformation());
                      },
                      child: Text(
                        "Next",
                        style: TextStyle(
