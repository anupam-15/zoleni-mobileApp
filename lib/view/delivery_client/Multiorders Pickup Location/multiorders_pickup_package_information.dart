...
class MultiordersPackageInformation extends StatefulWidget {
  const MultiordersPackageInformation({super.key});

  @override
  State<MultiordersPackageInformation> createState() => _MultiordersPackageInformationState();
}

class _MultiordersPackageInformationState extends State<MultiordersPackageInformation> { String? selectDropSelect;
String? selectUnit;
