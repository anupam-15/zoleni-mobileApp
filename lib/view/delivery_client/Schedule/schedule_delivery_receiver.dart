...
import 'package:zoleni/view/delivery_client/Schedule/schedule_delivery_package_information.dart';
...
class ScheduleDeliveryReceiver extends StatefulWidget {
  const ScheduleDeliveryReceiver({super.key});

  @override
  State<ScheduleDeliveryReceiver> createState() => _ScheduleDeliveryReceiverState();
}

class _ScheduleDeliveryReceiverState extends State<ScheduleDeliveryReceiver> {
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Scheduled Delivery Order-Receiver Details",
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Get.to(ScheduleDeliveryPackageInformation());
                      },
                      child: Text(
                        "Next",
                        style: TextStyle(
