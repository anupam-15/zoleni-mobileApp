...
class ScheduleDeliveryPackageInformation extends StatefulWidget {
  const ScheduleDeliveryPackageInformation({super.key});

  @override
  State<ScheduleDeliveryPackageInformation> createState() => _ScheduleDeliveryPackageInformationState();
}

class _ScheduleDeliveryPackageInformationState extends State<ScheduleDeliveryPackageInformation> { String? selectDropSelect;
String? selectUnit;
