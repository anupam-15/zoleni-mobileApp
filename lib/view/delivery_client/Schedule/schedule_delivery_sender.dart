...
import 'package:zoleni/view/delivery_client/Schedule/schedule_delivery_receiver.dart';
import 'package:responsive_sizer/responsive_sizer.dart';
import '../../../exports/get_export.dart';
import '../../../exports/globle_exports.dart';
import '../../widgets/appbar.dart';

class ScheduleDeliverySender extends StatefulWidget {
  const ScheduleDeliverySender({super.key});

  @override
  State<ScheduleDeliverySender> createState() => _ScheduleDeliverySenderState();
}

class _ScheduleDeliverySenderState extends State<ScheduleDeliverySender> {
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Scheduled Delivery Order-Sender Details",
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                       Get.to(ScheduleDeliveryReceiver());
